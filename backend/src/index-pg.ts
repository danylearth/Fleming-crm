  ...
  try {
    ...
    await run(`
      UPDATE tenant_enquiries SET
        ...
        app_next_of_kin_name=$21, app_next_of_kin_phone=$22, app_next_of_kin_relationship=$23,
        app_signature=$24, app_signed_at=NOW(), app_declaration_agreed=$25,
        application_form_completed=1,
        current_address_1=COALESCE($26, current_address_1),
        date_of_birth_1=COALESCE($27, date_of_birth_1),
        employer_1=COALESCE($28, employer_1),
        income_1=COALESCE($29, income_1),
        employment_status_1=COALESCE($30, employment_status_1),
        app_employer_address=$32, app_employer_contact=$33,
        app_years_of_service=$34, app_pay_frequency=$35,
        app_other_income=$36, app_tax_years=$37
      WHERE application_form_token=$31
    `, [
