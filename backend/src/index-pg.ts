  ...
  try {
    ...
    await run(`
      UPDATE tenant_enquiries SET
        ...
        current_address_1=COALESCE($31, current_address_1),
        date_of_birth_1=COALESCE($32, date_of_birth_1),
        employer_1=COALESCE($33, employer_1),
        income_1=COALESCE($34, income_1),
