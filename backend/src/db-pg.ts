  ...
  try {
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS properties (
        ...
        leasehold_issued_by TEXT,
        leasehold_email TEXT,
        ...
        status TEXT DEFAULT 'to_let' CHECK(status IN ('to_let', 'available', 'let', 'let_agreed', 'full_management', 'rent_collection', 'maintenance', 'closed')),
        onboarded_date DATE,
        notes TEXT,
        amenities TEXT,
      ...
      CREATE TABLE IF NOT EXISTS property_expenses (
        ...
        receipt_document_id INTEGER REFERENCES documents(id) ON DELETE SET NULL,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
      );
    ...
    // Structured leasehold/management-company records and richer property costs.
    await client.query(`
    ...
    await client.query(`
      DO $$ BEGIN
        ...
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS app_form_data JSONB DEFAULT '{}'::jsonb;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS app_signature_name TEXT;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS app_signature_ip TEXT;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS app_signature_user_agent TEXT;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS app_revision INTEGER DEFAULT 0;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS application_review_status TEXT DEFAULT 'pending';
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS application_review_notes TEXT;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS application_reviewed_at TIMESTAMP;
        ALTER TABLE tenant_enquiries ADD COLUMN IF NOT EXISTS application_reviewed_by INTEGER;
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS tenancy_agreements (
        ...
        size INTEGER,
        status TEXT NOT NULL DEFAULT 'issued' CHECK (status IN ('issued', 'tenant_signed', 'completed', 'void')),
    ...
    try {
      ...
      await client.query(`
        ...
        CHECK (status IN ('to_let', 'available', 'let', 'let_agreed', 'full_management', 'rent_collection', 'maintenance', 'closed'))
      `);
