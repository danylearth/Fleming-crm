...
export function EnquiriesIcon(props: IconProps) {
  const p = defaults(props);
  return <svg {...p}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /><line x1="9" y1="9" x2="15" y2="9" /><line x1="9" y1="13" x2="13" y2="13" /></svg>;
}
...
export function LandlordsIcon(props: IconProps) {
  const p = defaults(props);
...
export function BdmIcon(props: IconProps) {
  const p = defaults(props);
...
// Enquiry status icons
export function NewIcon(props: IconProps) {
  const p = defaults(props);
  return <svg {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z" /><polyline points="14 2 14 8 20 8" /><line x1="12" y1="12" x2="12" y2="18" /><line x1="9" y1="15" x2="15" y2="15" /></svg>;
}

export function ViewedIcon(props: IconProps) {
  const p = defaults(props);
...
export function BookingIcon(props: IconProps) {
  const p = defaults(props);
  return <svg {...p}><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /><circle cx="12" cy="15" r="1.5" fill="currentColor" stroke="none" /></svg>;
}

export function AwaitingIcon(props: IconProps) {
  const p = defaults(props);
...
export function ConvertedIcon(props: IconProps) {
  const p = defaults(props);
